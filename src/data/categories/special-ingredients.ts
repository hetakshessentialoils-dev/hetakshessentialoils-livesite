...
export const category: Category = {
  ...
  description: "Our curated selection of special ingredients is chosen for its unique properties and is used as products in dietary supplements, herbal remedies and much more.",
  seoTitle: "Special Ingredients Oils Manufacturer & Wholesale Suppliers in USA",
  seoDescription: "Special Ingredients Oils manufacturer and bulk supplier in USA – Hetaksh Essential Oils provides high-quality specialty oils in wholesale quantities with reliable supply.",
...
export const image = "/assets/images/project/special-ingredients-oil.webp";
