...
<section class="single-page-header dark">
  <div  class="page-header-bg" style="background-image: url('/assets/images/products/single-product/tea-tree-oil/tea-tree-oil-bulk.webp');"></div>
  <div class="container">
        ...
        <div class="col-xl-5 col-lg-5 col-md-6">
          <div class="form-box">
            <h4 class="section-title__title">
              Contact us for TEA TREE OIL Enquiries
            </h4>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="webpage" value="Enquiry from TEA TREE OIL Page">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        <div class="heading-box">
          <h4>
            TEA TREE OIL COA & MSDS
          </h4>
          <!-- <h6 class="mb-2">Thymoquinone – min 1%</h6> -->
        </div>
        <div class="product__btn-box">
          <a href="/assets/images/products/single-product/tea-tree-oil/TEA-TREE-OIL-COA.pdf" target="_blank"class="product__btn thm-btn"><i class="fa fa-download" aria-hidden="true"></i> COA </a><a href="/assets/images/products/single-product/tea-tree-oil/TEA-TREE-OIL-MSDS.pdf" target="_blank" class="product__btn thm-btn thm-btn2"><i class="fa fa-download" aria-hidden="true"></i> MSDS </a>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="product-content-left">
            <div class="about-one__img-box wow slideInLeft animated animated" data-wow-delay="100ms">
              <div class="product__img">
                <img src="/assets/images/products/single-product/tea-tree-oil/tea-tree-oil-bulk-suppliers.webp" alt="Tea Tree Oil Bulk Supplier">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="product-content-right">
            <div class=" wow slideInRight animated" data-wow-delay="100ms">
              <h2 class="section-title__title">
                BULK Manufacturer of TEA TREE OIL From USA
              </h2>
              <p class="mb-3">
                At Hetaksh, we are offering Pharmaceutical grade Tea Tree Oil which is available in a grade complying with the applicable BP/Ph. Eur. monograph.
              </p>
              <h5>
                <p class="mb-3">
                  The major components of Hetaksh Tea Tree Oil typically include:
                </p>
              </h5>
              <p class="mb-3">
                1. Terpinen-4-ol, Alpha Pinene, Sabinene Alpha Terpinene, Limonene, Cineol ,Gamma Terpinene, Para Cymene , Terpinolene, Terpinen-4-ol, Aromadendrene & Alpha Terpineol.
              </p>
              <p class="mb-3">
                2. Terpinen-4-ol: This is the most abundant and well-studied component of tea tree oil bulk manufacturer, and is responsible for many of its antimicrobial and anti-inflammatory properties.
              </p>
              <p class="mb-3">
                3. Gamma-terpinene: This is another important component of tea tree oil that has been shown to have antimicrobial activity.
              </p>
              <p class="mb-3">
                4. Alpha-terpinene: This compound is also found in tea tree oil and has been shown to have antioxidant and anti-inflammatory properties.
              </p>
              <p class="mb-3">
                5. 1,8-cineole (eucalyptol): This compound is found in small amounts in <b>Tea tree oil wholesale suppliers</b>, and has been shown to have anti-inflammatory and analgesic properties.
              </p>
              <p>
                Other minor components of Tea Tree Oil include Alpha-pinene, Limonene, Terpinolene, and Sabinene.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-5 col-lg-6 col-md-6">
          <div class="product-content-left">
            <div class="about-one__img-box wow slideInLeft animated" data-wow-delay="120ms">
              <div class="product__img">
                <img src="/assets/images/products/single-product/tea-tree-oil/Tea-Tree-Oil-Wholesale.webp" alt="Tea Tree Oil Wholesale">
              </div>
            </div>
          </div>
        </div>
...
<section class="single-product-section-dark">
  <div class="servie-bg-box">
    <div class="single_service__bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%" style="background-image: url(/assets/images/products/single-product/tea-tree-oil/tea-tree-oil-bulk.webp);"></div>
  </div>
  <div class="container">
    <div class="section-title ">
      <h2 class="section-title__title">
        Manufacturers and Bulk Suppliers of TEA TREE OIL
      </h2>
    </div>
    <div class="row">
      <div class="col-md-12">
        <p>
          We proudly introduce ourselves "Tea Tree Oil Suppliers" as leading manufacturers, suppliers of Essential Oils, Carrier Oils, Hydrosols, Floral Oils etc.
        </p>
        <p>
          We are Wholesale & Bulk suppliers of "Tea Tree Oil" throughout Pharmaceutical Companies, Cosmetic companies etc. Currently we are exporting to more than 40 countries worldwide. We are one of the largest cultivators and exporters with ISO 9001:2015 & GMP accreditation.
        </p>
        <p>
      ...
      <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6">
          <div class="product-content-left">
            <div class="about-one__img-box wow slideInLeft animated animated" data-wow-delay="100ms">
              <div class="product__img">
                <img src="/assets/images/products/single-product/tea-tree-oil/Tea-Tree-Oil-Suppliers.webp" alt="Tea tree oil supplier">
              </div>
            </div>
          </div>
        </div>
...
export const faqs: FaqItem[] = [
  {
    question: "Is Tea Tree Oil used in acne care products?",
    answer: "Yes, Tea Tree Oil is commonly used in face washes, creams, and serums. Many manufacturers use it in acne care products.",
  },
  {
    question: "What certifications do you offer for Tea Tree Oil?",
    answer: "We provide COA, MSDS, ISO, GMP, Halal, and Kosher documents. These are available for bulk orders.",
  },
  {
    question: "Do you offer Tea Tree Oil in bulk quantities?",
    answer: "Yes, we supply Tea Tree Oil in bulk quantities to businesses worldwide.",
  },
  {
    question: "Do you provide a Non-GMO declaration for Tea Tree Oil?",
    answer: "Yes, a Non-GMO declaration can be provided upon request. As a trusted supplier, we also provide other required documents.",
  },
  {
    question: "Which countries do you supply Tea Tree Oil to?",
    answer: "We supply Tea Tree Oil to customers in more than 40 countries. We work with distributors and businesses globally.",
  },
];
