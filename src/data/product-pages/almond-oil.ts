...
export const htmlPage: ProductPageHtml = {
  ...
  seoTitle: "Almond Oil Wholesale & Manufacturers | Suppliers In USA",
  seoDescription: "Premium Almond Oil Wholesale Suppliers offering 100% pure, natural almond oil for skincare, haircare, and cosmetics. Bulk supply at competitive prices in USA.",
  category: "essential-oils",
  categoryName: "Essential Oils",
  html: `
<section class="single-page-header dark">
  <div id="sing-bg-img-5" class="page-header-bg"></div>
  <div class="container">
        ...
        <div class="col-xl-5 col-lg-5 col-md-6">
          <div class="form-box">
            <h4 class="section-title__title">
              Contact us for Wholesale Almond Oil Enquiries
            </h4>
                  ...
                  <div class="form-group">
                    <input type="text" name="name" id="name" class="form-control"
                      ...
                      <input type="hidden" name="webpage"
                                                    value="Enquiry from  Almond Oil Page">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
              ...
              <div class="single-details__content">
                <div class="row">
                  <div class="col-xl-5 col-lg-6 col-md-6">
                    <div class="product-content-left">
                      <div class="about-one__img-box wow slideInLeft animated animated"
                        ...
                        <div class="product__img">
                          <img
                                            src="/assets/images/products/single-product/Almond-Oil/Almond-Oil-Supplier.webp"
                                            alt="Almond Oil Supplier">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-xl-7 col-lg-6 col-md-6">
                      <div class="product-content-right">
                        <div class=" wow slideInRight animated" data-wow-delay="100ms">
                          ...
                          <p class="mb-3">
                            Almond Oil is composed primarily of oleic acid , linoleic acid, and saturated fatty acids. Oleic acid is a monounsaturated fatty acid that is known for its ability to penetrate the skin and hair shaft, while linoleic acid is an essential fatty acid that helps to strengthen the skin barrier and retain moisture.
                          </p>
                          <h2 class="section-title__title">
                            Extraction
                          </h2>
                          ...
                          <div class="product__btn-box">
                            <a
                                            href="/assets/images/products/single-product/Almond-Oil/ALMOND-OIL-COA.pdf"
                                            class="product__btn thm-btn">
                              <i class="fa fa-download"
                                                aria-hidden="true"></i> COA </a>
                                <a
                                            href="/assets/images/products/single-product/Almond-Oil/Almond-OIL-MSDS.pdf"
                          ...
                          <div class="row">
                            <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="product-content-left wow slideInLeft animated animated" data-wow-delay="100ms">
                                ...
                                <p class="about-one__text">
                                  There are two types of Almond Oil &ndash; Sweet Almond Oil and Bitter Almond oil. Sweet Almond Oil is the most commonly used and is extracted from the edible Almonds. It has a mild, nutty aroma and is rich in vitamins and minerals. Hetaksh Essential Oils supplies bulk Sweet Almond Oil and are premium oil manufacturers.&nbsp;<br /><br /> Bitter Almond Oil, on the other hand, is extracted from bitter almonds and is widely used in skincare or haircare products.<br /><br /> Benefits: Almond Oil is a popular ingredient in skincare and haircare products due to its many benefits. It is a natural emollient that helps to soften and soothe the skin and hair, and is rich in vitamin E, which helps to nourish and protect the skin from environmental damage. It is also a natural anti-inflammatory and can help to reduce redness and irritation in the skin.<br /><br /><strong>GET BEST OFFERS ON BULK ALMOND OIL !!</strong><br> If you are looking for a reliable sweet Almond oil supplier, Hetaksh Essential Oils is a reliable supplier. We supply Sweet Almond Oil in bulk or wholesale quantities, allowing you to buy the amount you need at a discounted price. As a reputable <strong class="cyb">Almond Oil bulk manufacturer</strong>, we use the highest quality almonds and employ strict quality control measures to ensure the purity and potency of the oil. Hetaksh Essential Oils is a reliable wholesale supplier of Almond Oil who can help you obtain the high-quality ingredients you need to create effective and beneficial products.
                                </p>
                              </div>
                            </div>
                            <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="product-content-right">
                                <div class="about-one__img-box wow slideInRight animated animated"
                                  ...
                                  <div class="product__img">
                                    <img
                                            src="/assets/images/products/single-product/Almond-Oil/Almond-Oil-Wholesale.webp"
                                            alt="Almond Oil Wholesale">
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-xl-5 col-lg-6 col-md-6">
                                <div class="product-content-left">
                                  <div class="about-one__img-box wow slideInLeft animated" data-wow-delay="120ms">
                                    <div class="product__img">
                                      <img
                                            src="/assets/images/products/single-product/Almond-Oil/Almond-Oil-wholesale-supplier.webp" alt="Almond Oil Wholesale Supplier">
                                    </div>
                                  </div>
                                </div>
                              </div>
                    ...
                    style="background-image: url(/assets/images/products/single-product/Almond-Oil/Almond-Oil-Manufacturers.webp);"></div>
                        </div>
                        <div class="container">
                          ...
                          <div class="row">
                            ...
                            <div class="col-xl-5">
                              <ul class="project-details__points-list list-unstyled">
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Our Almond Oil is extracted from Non-GMO Seeds.
                                </li>
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Our Almond Oil is Pyrrolizidine Alkaloids free.
                                </li>
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Almond Oil process by us does not contain any aflatoxins.
                                </li>
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Melamine is absent in our Almond Oil.
                                </li>
                              </ul>
                            </div>
                            <div class="col-xl-7">
                              <ul class="project-details__points-list list-unstyled">
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Our Almond Oil is manufactured in Halal and Kosher Facility.
                                </li>
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> We do not use any residual solvent in the manufacturing process of Almond Oil.
                                </li>
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Almond Oil offered by us is free from any potential Allergen, Dioxin and Genotoxic Impurities.
                                </li>
                                <li>
                                  <i class="fa fa-check" aria-hidden="true"></i> Our Almond Oil is pesticides free.
                                </li>
                              </ul>
                            </div>
                          </div>
                              ...
                              <div class="col-xl-5 col-lg-6 col-md-6">
                                <div class="product-content-left">
                                  <div class="about-one__img-box wow slideInLeft animated animated"
                                    ...
                                    <div class="product__img">
                                      <img
                                            src="/assets/images/products/single-product/Almond-Oil/Almond-Oil-Wholesale.webp" alt="Almond Oil Bulk Wholesale">
                                    </div>
                                  </div>
                                </div>
                              </div>
...
export const faqs: FaqItem[] = [
  {
    question: "What is the shelf life of Almond Oil for bulk quantity orders?",
    answer: "When stored in a cool and dry place, our Almond Oil has a shelf life of up to 2 years. Proper storage helps maintain the quality of Almond Oil during its shelf life.",
  },
  {
    question: "How can I place a bulk order for Almond Oil?",
    answer: "You can place a bulk Almond Oil order by contacting us via mail, WhatsApp, or call with your required quantity and specifications.",
  },
  {
    question: "Do you export Almond Oil in bulk internationally?",
    answer: "Yes, we export bulk quantities of Almond Oil worldwide.",
  },
  {
    question: "Can you provide a sample before placing a bulk commercial order?",
    answer: "Yes, samples can be provided for testing and evaluation.",
  },
  {
    question: "Do you provide quality documents with Almond Oil?",
    answer: "Yes, COA and related documents are available upon request.",
  },
];
