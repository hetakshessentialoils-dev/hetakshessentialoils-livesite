  ...
  specs: [
    {
      ...
      value: "Emblica officinalis / Phyllanthus emblica",
    },
    {
      label: "Other Name",
      value: "Indian Gooseberry Oil",
    },
    {
      label: "Origin",
      value: "India",
    ...
    {
      label: "Plant Parts Used",
      value: "Fruits and Seeds",
    },
    {
      label: "Color",
      value: "Yellow to Greenish Yellow",
    },
    {
      label: "Odor",
      value: "Mild, Characteristic Fruity Aroma",
    },
  ],
...
export const faqs: FaqItem[] = [
  {
    question: "Why is Hetaksh Essential Oils suitable for bulk hair and scalp formulations?",
    answer: "Our Amla Oil is rich in antioxidants, vitamin C, and essential fatty acids that help nourish the scalp, support natural pigmentation, and improve the overall condition of the hair. It is widely used in Ayurvedic hair oils and cosmetic formulations.",
  },
  {
    question: "Do you perform quality checks before supplying Amla Oil in bulk?",
    answer: "Yes. Every batch undergoes strict laboratory testing and quality inspections before dispatch. We also provide complete quality documents to verify product specifications and consistency.",
  },
  {
    question: "What certifications do you provide with bulk Amla Oil?",
    answer: "We provide COA, MSDS, TDS, Allergen Declaration, Non-GMO Declaration, GMP, ISO, FSSAI, Halal, and Kosher certifications with our bulk supplies.",
  },
  {
    question: "What is the shelf life of Amla Oil?",
    answer: "Our Amla Oil has a shelf life of up to two years when stored in a cool, dry place away from direct sunlight.",
  },
  {
    question: "Do you supply Amla Oil internationally in bulk quantities?",
    answer: "Yes. We export professional-grade quality Amla Oil in bulk quantities to customers worldwide with secure packaging, complete export documentation, and reliable air and sea freight services.",
  },
];
