...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Color",
      value: "Greenish Yellow to Yellow-Green",
    },
    {
      label: "Aroma",
      value: "Fresh, Citrus, Sweet, Slightly Floral",
    },
  ],
...
export const faqs: FaqItem[] = [
  {
    question: "Can I apply Bergamot Oil directly to my skin?",
    answer: "No. Bergamot Essential Oil should never be applied directly to the skin. Always dilute it with a carrier oil such as jojoba oil, sweet almond oil, or olive oil before use.",
  },
  {
    question: "What is the recommended dilution ratio for Bergamot Oil?",
    answer: "For facial application, a dilution of about 1% (approximately one drop of Bergamot Oil per teaspoon of carrier oil) is recommended. For body applications, use a lower dilution as required. Always perform a patch test before regular use.",
  },
  {
    question: "What are the common uses of Bergamot Oil?",
    answer: "Bergamot Oil is widely used in skincare products, hair care products, perfumes, soaps, candles, massage oils, aromatherapy diffusers, and wellness formulations. It is also used to provide flavour for Earl Grey tea.",
  },
  {
    question: "Do you supply Bergamot Oil in bulk quantities?",
    answer: "Yes. We are a bulk manufacturer, wholesaler, and exporter of Bergamot Essential Oil, supplying premium quality oil to customers worldwide.",
  },
  {
    question: "Do you provide quality documents with bulk Bergamot Oil?",
    answer: "Yes. Every bulk order is supplied with COA, MSDS, Technical Data Sheet (TDS), and other required export documentation to ensure quality and compliance.",
  },
];
