...
export const landing: ProductLanding = {
  ...
  grades: [
    {
      ...
      spec: "Thymoquinone – min 1%",
      coa: "/assets/images/products/single-product/black-cumin-seed-oil/BLACK-SEED-OIL-1-COA.pdf",
      msds: "/assets/images/products/single-product/black-cumin-seed-oil/MSDS-BLACK-CUMIN-OIL-1.pdf",
    },
    {
      title: "Black Seed Oil",
      spec: "Thymoquinone – min 3%",
      coa: "/assets/images/products/single-product/black-cumin-seed-oil/BLACK-SEED-OIL-3-COA.pdf",
      msds: "/assets/images/products/single-product/black-cumin-seed-oil/MSDS-BLACK-CUMIN-OIL-3.pdf",
    },
    {
      title: "Black Seed Oil",
      spec: "Thymoquinone – min 5%",
      coa: "/assets/images/products/single-product/black-cumin-seed-oil/BLACK-SEED-OIL-5-COA.pdf",
      msds: "/assets/images/products/single-product/black-cumin-seed-oil/MSDS-BLACK-CUMIN-OIL-5.pdf",
    },
    {
      title: "Black Seed Oil",
      spec: "Thymoquinone – min 10%",
      coa: "/assets/images/products/single-product/black-cumin-seed-oil/BLACK-SEED-OIL-10-COA.pdf",
      msds: "/assets/images/products/single-product/black-cumin-seed-oil/MSDS-BLACK-CUMIN-OIL-10.pdf",
    },
    {
      title: "Black Seed Oil",
      spec: "Thymoquinone – min 20%",
      coa: "/assets/images/products/single-product/black-cumin-seed-oil/BLACK-SEED-OIL-20-COA.pdf",
      msds: "/assets/images/products/single-product/black-cumin-seed-oil/MSDS-BLACK-CUMIN-OIL-10.pdf",
    },
  ],
  manufacturer: {
  ...
  documents: {
    image: "/assets/images/products/single-product/black-cumin-seed-oil/Black-seed-oil-wholesale.webp",
  ...
  aim: {
    image: "/assets/images/products/single-product/black-cumin-seed-oil/Black-seed-oil-suppliers.webp",
...
export const faqs: FaqItem[] = [
  {
    ...
    answer: "Our black seed oil is available with thymoquinone levels from 1% to 20%. As a supplier, we provide COA and test reports for quality verification.",
  },
  {
    question: "Where is your black seed oil manufactured?",
    answer: "Our black seed oil is manufactured in India using carefully selected Nigella sativa seeds. As a manufacturer, we follow strict quality standards.",
  },
  {
    question: "What is the MOQ for black seed oil?",
    answer: "The minimum order quantity is usually 25 kg. We also support bulk orders based on customer requirements.",
  },
  {
    question: "What are the uses of black seed oil?",
    answer: "Black seed oil is widely used in pharmaceutical, nutraceutical, cosmetic, and personal care products. We offer wholesale quantities for different industries.",
  },
  {
    question: "How do you ensure the quality of black seed oil?",
    answer: "We test every batch for purity and quality before dispatch. As a trusted supplier, we provide COA, MSDS, and other required documents.",
  },
];
