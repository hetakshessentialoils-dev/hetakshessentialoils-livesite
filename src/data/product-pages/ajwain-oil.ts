...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    },
    {
      ...
      value: "Trachyspermum ammi",
    },
    {
      label: "Common Names",
      value: "Ajowan Oil, Carom Seed Oil, Bishop’s Weed Oil",
    },
    {
      label: "Plant Family",
      value: "Apiaceae",
    ...
    {
      label: "Odour",
      value: "Strong, warm, spicy, sharp, and thyme-like",
    },
    {
...
export const faqs: FaqItem[] = [
  {
    question: "What are the uses of Ajwain Hydrosol?",
    answer: "Ajwain Hydrosol is widely used in bulk for manufacturing face mists, body mists, linen sprays, room sprays, bath products, lotions, creams, and shampoos.",
  },
  {
    question: "Is Ajwain Oil available in bulk quantities?",
    answer: "Yes, we supply Ajwain Oil in bulk quantities to manufacturers, wholesalers, and exporters worldwide.",
  },
  {
    question: "Do you offer competitive prices for Ajwain Oil?",
    answer: "Yes, our Ajwain Oil is available at competitive prices for bulk quantities.",
  },
  {
    question: "What is the lead time for bulk Ajwain Oil orders?",
    answer: "The lead time depends on the order quantity. Most bulk orders are dispatched within 2–7 working days.",
  },
  {
    question: "What is the process for ordering Ajwain Oil in bulk?",
    answer: "Our team understands your sourcing requirements, shares COA and samples on request for quality evaluation, provides a quotation, and ensures timely delivery with secure packaging.",
  },
];
