...
export const page: CleanProductPage = {
  ...
  paragraphs: [
    ...
    "As one of the leading <b>Arachis Oil wholesale</b> from the United States, our team ensures that our product is free from pesticides and client safety remains our priority. Arachis oil contains essential nutrients like vitamin E, omega-6 fatty acids, and antioxidants which makes it usable for making injections. Arachis oil's antioxidants and fatty acids may help nourish and protect the skin and also hair.",
  ],
  coa: "/assets/images/products/single-product/arachis-oil/ARACHIS-OIL-BP.pdf",
  msds: "/assets/images/products/single-product/arachis-oil/ARACHIS-OIL-MSDS.pdf",
  ...
  variants: [
    ...
    },
    {
      ...
      msds: "/assets/images/products/Pharma-Grade-Oils/MSDS/ARACHIS OIL MSDS.pdf",
      paragraphs: [
        "Arachis Oil USP is a highly refined peanut oil that complies with United States Pharmacopeia (USP) standards for pharmaceutical use. We manufacture Arachis Oil USP under strict quality checks to ensure high purity, safety, and consistency for sensitive medical applications. As a leading <b>Arachis Oil Bulk Distributor</b>, we supply Arachis Oil USP to pharmaceutical companies, healthcare manufacturers, and formulation industries.",
  ...
  specs: [
    ...
    },
    {
      ...
      value: "Peanut Oil, Groundnut Oil",
    },
    {
      label: "Plant Family",
      value: "Fabaceae",
    ...
    {
      label: "Odour",
      value: "Mild, Characteristic, Nutty",
    },
    {
      label: "Colour",
    ...
    {
      label: "Solubility",
      value: "Insoluble in Water; Soluble in Many Organic Solvents",
    },
    {
      label: "Nature",
      value: "Fixed Vegetable Oil",
    },
    {
      label: "Main Fatty Acids",
      value: "Oleic Acid, Linoleic Acid",
    },
    {
      label: "Plant Part",
      value: "Seeds",
    },
    {
      ...
      value: "Pressing or Suitable Oil Extraction",
    },
  ],
};
...
export const faqs: FaqItem[] = [
  {
    question: "What is the MOQ for bulk supply of Arachis Oil?",
    answer: "The minimum order quantity (MOQ) for bulk supply of Arachis Oil is 25 kg.",
  },
  {
    question: "Do you provide MSDS, TDS, and COA for bulk orders?",
    answer: "Yes, we provide MSDS, TDS, COA with bulk orders.",
  },
  {
    question: "Do you offer Arachis Oil at competitive bulk prices?",
    answer: "Yes, as bulk manufacturers and exporters, we offer premium quality Arachis Oil at competitive prices.",
  },
  {
    question: "Do you export Arachis Oil worldwide?",
    answer: "Yes, we export premium quality Arachis Oil to customers all over the world.",
  },
  {
    question: "Is your Arachis Oil available in different grades?",
    answer: "Yes, we supply Arachis Oil, Arachis Oil BP, and Arachis Oil USP in bulk to meet different industrial requirements.",
  },
];
