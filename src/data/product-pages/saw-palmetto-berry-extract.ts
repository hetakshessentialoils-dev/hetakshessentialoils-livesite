...
export const landing: ProductLanding = {
  ...
  grades: [
    {
      ...
      spec: "USP NF",
      coa: "/assets/images/products/single-product/Saw-Palmetto-Oil/USP-SAW-PALMETTO-EXTRACT.pdf",
      msds: "/assets/images/products/single-product/Saw-Palmetto-Oil/MSDS-SAW-PALMETTO-EXTRACT.pdf",
    },
    {
      title: "Saw Palmetto Oil",
      spec: "85% Minimum Fatty Acids, 32% Lauric Acid",
      coa: "/assets/images/products/single-product/Saw-Palmetto-Oil/85-SAW-PALMETTO-OIL.pdf",
      msds: "/assets/images/products/single-product/Saw-Palmetto-Oil/MSDS-SAW-PALMETTO-EXTRACT-85.pdf",
    },
    {
      title: "Saw Palmetto Extract",
      spec: "45%",
      coa: "/assets/images/products/single-product/Saw-Palmetto-Oil/45-SAW-PALMETTO-EXTRACT.pdf",
      msds: "/assets/images/products/single-product/Saw-Palmetto-Oil/MSDS-SAW-PALMETTO-EXTRACT-45.pdf",
    },
    {
      title: "Saw Palmetto Extract",
      spec: "25%",
      coa: "/assets/images/products/single-product/Saw-Palmetto-Oil/25-SAW-PALMETTO-EXTRACT.pdf",
      msds: "/assets/images/products/single-product/Saw-Palmetto-Oil/MSDS-SAW-PALMETTO-EXTRACT-25.pdf",
    },
  ],
  manufacturer: {
  ...
  documents: {
    image: "/assets/images/products/single-product/Saw-Palmetto-Oil/Saw-Palmetto-Oil-Suppliers.webp",
  ...
  wholesale: {
    ...
    bgImage: "/assets/images/products/single-product/Saw-Palmetto-Oil/saw-Palmetto-oil-bulk.webp",
    paragraphs: [
  ...
  aim: {
    image: "/assets/images/products/single-product/Saw-Palmetto-Oil/Saw-Palmetto-Oil-manufacturers.webp",
...
export const faqs: FaqItem[] = [
  {
    question: "What are the different saw palmetto specifications you offer?",
    answer: "We offer Saw Palmetto Extract USP, Saw Palmetto Oil, Saw Palmetto Extract 45%, and Saw Palmetto Extract 25%. As a manufacturer, we provide different specifications for various industry needs.",
  },
  {
    question: "What certifications do you offer?",
    answer: "As a supplier, we provide certifications such as ISO, GMP, Halal, Kosher, and other documents as required.",
  },
  {
    question: "What extraction process is used for saw palmetto oil?",
    answer: "Saw palmetto oil is usually extracted using supercritical CO₂ extraction or solvent extraction. We ensure quality and consistency in every bulk order.",
  },
  {
    question: "What are the benefits of saw palmetto oil?",
    answer: "Saw palmetto oil is commonly used in nutraceutical and personal care products. As a wholesale provider, we supply high-quality oil for different applications.",
  },
  {
    question: "How should saw palmetto oil be stored?",
    answer: "Store saw palmetto oil in a tightly sealed container in a cool, dry place away from direct sunlight. Proper storage helps maintain the quality of bulk quantities.",
  },
];
