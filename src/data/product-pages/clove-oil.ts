 ...
 * Clove Oil
 *
 * Meta title: Clove Oil Manufacturer & Distributor | Bulk Clove Essential Oil Supplier
 * Meta description: Buy bulk Clove Oil, Clove Oil BP, Clove Oil IP, Clove Bud Oil, and Clove Bud Hydrosol. COA, MSDS, TDS, and worldwide shipping.
 *
...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Origin",
      value: "India / major clove-producing regions",
    },
    {
      label: "Appearance",
    ...
    {
      label: "Aroma",
      value: "Warm, Sweet, Spicy and Strong",
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Clove Oil has applications across several industries:",
      ],
      lists: [
        {
          columns: 2,
...
export const faqs: FaqItem[] = [
  {
    question: "What is the main constituent of Clove Oil?",
    answer: "Eugenol is the principal naturally occurring constituent of Clove Oil. Other compounds include eugenyl acetate, beta-caryophyllene, and alpha-humulene.",
  },
  {
    question: "What is the difference between Clove Oil and Clove Bud Oil?",
    answer: "Clove Bud Oil specifically refers to oil obtained from the dried flower buds of Syzygium aromaticum. Clove Oil is a broader commercial name that is sometimes used for clove essential oil, so buyers should check the plant part and product specification before placing their orders.",
  },
  {
    question: "Do you supply Clove Oil BP and Clove Oil IP in bulk?",
    answer: "Yes. We supply Clove Oil BP and Clove Oil IP in bulk quantities for buyers requiring pharmaceutical-grade clove oil.",
  },
  {
    question: "What is the MOQ for bulk Clove Oil?",
    answer: "Our standard MOQ starts from 25 kg. Larger quantities can be supplied according to the buyer’s requirement and product grade.",
  },
  {
    question: "Can you provide COA and technical documents with bulk Clove Oil?",
    answer: "Yes. COA, MSDS, TDS, product specifications, and other applicable technical or export documents can be provided according to the product and customer’s requirements.",
  },
];
