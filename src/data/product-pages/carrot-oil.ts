...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Aroma",
      value: "Mild, Characteristic Botanical Aroma",
    },
    {
      label: "Typical Applications",
      value: "Skincare, Hair Care, Cosmetics, Massage and Wellness",
    },
  ],
  ...
  variants: [
      ...
      tables: [
        {
          ...
          rows: [
            ...
            {
              label: "Aroma",
              value: "Earthy, Warm, Dry & Characteristic",
            },
            {
              label: "Product Type",
              value: "Essential Oil",
    ...
    },
    {
      ...
      paragraphs: [
        "The composition of Carrot Seed Oil can include:",
      ],
      lists: [
        {
          columns: 2,
    ...
    },
    {
      ...
      paragraphs: [
        "Carrot Seed Oil is commonly selected for:",
      ],
      lists: [
        {
          columns: 2,
...
export const faqs: FaqItem[] = [
  {
    question: "What is the difference between Carrot Oil and Carrot Seed Oil?",
    answer: "Carrot Oil is generally an infused or macerated oil made using carrot material and a carrier oil, while Carrot Seed Oil is an essential oil distilled from carrot seeds.",
  },
  {
    question: "What is Carrot Seed Oil used for?",
    answer: "Carrot Seed Oil is used in skincare, facial oils, serums, creams, massage products, aromatherapy, body care, natural fragrance blends, and selected hair and scalp formulations.",
  },
  {
    question: "Do you supply Carrot Oil and Carrot Seed Oil in bulk?",
    answer: "Yes. We supply Carrot Oil and Carrot Seed Oil in commercial quantities for cosmetic manufacturers, personal care brands, aromatherapy companies, wholesalers, and distributors.",
  },
  {
    question: "What are the uses of Carrot Seed Hydrosol?",
    answer: "Carrot Seed Hydrosol can be used in facial mists, body sprays, toners, lotions, creams, hair care products, aromatherapy preparations, and other water-based botanical formulations.",
  },
  {
    question: "Can you provide COA and technical documents for bulk carrot products?",
