 ...
 * Cajeput Oil
 *
 * Meta title: Cajeput Oil Manufacturer & Distributor | Bulk Cajeput Essential Oil
 * Meta description: Buy bulk Cajeput Oil and Cajeput Hydrosol from a leading manufacturer and exporter. Steam distilled, with COA, MSDS, TDS, and worldwide shipping.
 *
  ...
  specs: [
    {
      ...
      value: "Melaleuca cajuputi",
    },
    {
      label: "Common Names",
      value: "Cajeput Oil, Cajuput Oil, Kajaput Oil",
    },
    {
      label: "Family",
      value: "Myrtaceae",
    ...
    {
      label: "Part Used",
      value: "Leaves and small branches",
    },
    {
      label: "Extraction",
    ...
    {
      label: "Colour",
      value: "Colourless to Pale Yellow or Greenish",
    },
    {
      label: "Aroma",
      value: "Fresh, Eucalyptus-like, Camphoraceous",
    },
    {
      label: "Main Compound",
      value: "1,8-Cineole",
...
export const faqs: FaqItem[] = [
  {
    question: "What is Cajeput Oil made from?",
    answer: "Cajeput Oil is mainly made from the leaves and small branches of Melaleuca cajuputi through steam distillation.",
  },
  {
    question: "What does Cajeput Oil smell like?",
    answer: "It has a fresh, strong, clean smell with eucalyptus-like and camphor notes.",
  },
  {
    question: "What is Cajeput Hydrosol used for?",
    answer: "Cajeput Hydrosol can be used in facial mists, body sprays, hair products, room sprays, soaps, lotions, and other water-based personal care products.",
  },
  {
    question: "Do you supply Cajeput Oil in bulk?",
    answer: "Yes. We supply Cajeput Oil in bulk quantities for manufacturers, wholesalers, distributors, cosmetic companies, aromatherapy brands, and personal care businesses.",
  },
  {
    question: "Do you provide documents with bulk Cajeput Oil?",
    answer: "Yes. COA, MSDS, TDS, product specifications, and other applicable documents can be provided according to the product and buyer’s requirements.",
  },
];
