...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    },
    {
      ...
      value: "Pimpinella anisum",
    },
    {
      label: "Common Names",
      value: "Aniseed Oil, Anise Seed Oil",
    },
    {
      label: "Plant Family",
      value: "Apiaceae",
    ...
    {
      label: "Odour",
      value: "Sweet, warm, spicy, and licorice-like",
    },
    {
    ...
    {
      label: "Solubility",
      value: "Insoluble in water; soluble in suitable oils and alcohol",
    },
  ],
};
...
export const faqs: FaqItem[] = [
  {
    question: "Do you offer Anise Oil in pharmaceutical grades?",
    answer: "Yes, we offer Anise Oil USP in bulk that meets United States Pharmacopeia (USP) standards.",
  },
  {
    question: "Do you offer Anise Oil in bulk quantities?",
    answer: "Yes, as bulk manufacturers and exporters, we supply Anise Oil in bulk quantities at competitive prices worldwide.",
  },
  {
    question: "Is your Anise Oil 100% natural?",
    answer: "Yes, we offer 100% pure and natural Anise Oil manufactured under strict quality standards.",
  },
  {
    question: "What are the applications of Anise Oil?",
    answer: "Anise Oil is widely used in aromatherapy, cosmetics, pharmaceuticals, skincare, hair care, perfumes, soaps, massage oils, scented candles, and personal care products.",
  },
  {
    question: "Do you provide export documents with bulk orders?",
    answer: "Yes, we export Anise Oil worldwide and provide all the necessary export documents, including MSDS, TDS, COA, and other required quality documents with bulk orders.",
  },
];
