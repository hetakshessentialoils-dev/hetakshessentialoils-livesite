...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Color",
      value: "Colorless to Pale Yellow",
    },
    {
      label: "Aroma",
      value: "Sweet, Floral, Woody",
    },
    {
  ...
  variants: [
    ...
    },
    {
      ...
      paragraphs: [
        "Hetaksh Essential Oils is committed to delivering premium quality Bois de Rose Oil Bulk Supplier and Bois de Rose Hydrosol with consistent purity and quality. Every batch undergoes strict laboratory testing before dispatch to ensure it meets international quality standards. Our products are available in bulk quantities starting from 25 kg and are packed securely in 25 kg to 180 kg HDPE drums for safe transportation. We provide complete documentation, including COA, MSDS, Technical Data Sheet (TDS), Allergen Declaration, and Non-GMO Declaration, along with certifications such as ISO, GMP, FSSAI, Halal, and Kosher. Our experienced logistics team ensures timely worldwide delivery with secure packaging and dependable shipping solutions. Whether you require Bois de Rose Oil for skincare, cosmetics, aromatherapy, perfumery, wellness, or personal care products, we provide competitive <b>Bois de Rose Oil wholesale</b> pricing, consistent product quality, and dedicated customer support for businesses across the globe.",
      ],
    },
  ],
...
export const faqs: FaqItem[] = [
  {
    question: "What are the common uses of Bois de Rose Oil?",
    answer: "Bois de Rose Oil is widely used in skincare products, facial creams, serums, lotions, shampoos, conditioners, perfumes, aromatherapy blends, massage oils, and body care products because of its pleasant aroma and skin-conditioning properties.",
  },
  {
    question: "Do you supply Bois de Rose Oil in bulk quantities?",
    answer: "Yes. We are a trusted bulk exporter of Bois de Rose Oil, supplying bulk quantities to cosmetic, wellness, and personal care industries worldwide.",
  },
  {
    question: "Is your Bois de Rose Oil 100% pure and natural?",
    answer: "Yes. Our Bois de Rose Oil is 100% pure and natural. Every batch undergoes strict laboratory testing to ensure quality, purity, and consistency.",
  },
  {
    question: "Do you provide quality documents with bulk orders?",
    answer: "Yes. We provide COA, MSDS, Technical Data Sheet (TDS), Allergen Declaration, Non-GMO Declaration, and other required export documents with every bulk shipment.",
  },
  {
    question: "What is the minimum order quantity for Bois de Rose Oil?",
    answer: "Our minimum order quantity (MOQ) for Bois de Rose Oil starts from 25 kg. We also offer secure packaging, competitive wholesale pricing, and worldwide shipping for bulk orders.",
  },
];
