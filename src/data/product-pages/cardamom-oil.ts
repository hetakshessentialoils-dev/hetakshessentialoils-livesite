...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Aroma",
      value: "Sweet, Fresh, Warm and Spicy",
    },
    {
      label: "Appearance",
      value: "Pale Yellow to Yellow Liquid",
    },
    {
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Cardamom Oil is commonly sourced by:",
      ],
      lists: [
        {
          columns: 2,
  ...
  variants: [
    ...
    },
    {
      ...
      paragraphs: [
        "For bulk requirements, relevant documents can include:",
      ],
      lists: [
        {
          columns: 2,
...
export const faqs: FaqItem[] = [
  {
    question: "What is Cardamom Oil made from?",
    answer: "Cardamom Oil is generally obtained from the seeds of Elettaria cardamomum through steam distillation.",
  },
  {
    question: "What are the main components of Cardamom Essential Oil?",
    answer: "Alpha-terpinyl acetate and 1,8-cineole are commonly reported as major constituents, along with compounds such as linalool, linalyl acetate, and alpha-terpineol.",
  },
  {
    question: "What is Cardamom Hydrosol used for?",
    answer: "Cardamom Hydrosol can be used in water-based cosmetic, personal care, aromatherapy, hair care, room spray, and wellness formulations.",
  },
  {
    question: "Do you supply Cardamom Oil in bulk quantities?",
    answer: "Yes. We supply Cardamom Oil for manufacturers, wholesalers, distributors, and other commercial buyers with bulk packaging and documentation support.",
  },
  {
    question: "Can you provide COA and technical documents for Cardamom Oil?",
    answer: "Yes. COA, TDS, MSDS, product specifications, and applicable export documents can be provided according to the product grade and buyer’s requirements.",
  },
];
