...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Odor",
      value: "Mild, Characteristic Fatty Aroma",
    },
    {
      label: "Solubility",
      value: "Insoluble in water and soluble in fixed oils",
    },
  ],
...
export const faqs: FaqItem[] = [
  {
    question: "What are the uses of Avocado Oil in bulk quantities?",
    answer: "Avocado Oil is widely used in skincare, hair care, cosmetics, massage oils, aromatherapy, personal care products, food applications, nutraceutical products, and pharmaceutical formulations.",
  },
  {
    question: "Do you offer Avocado Oil in international markets?",
    answer: "Yes. We export premium quality Avocado Oil in bulk quantities to customers across international markets with reliable air and sea freight logistics.",
  },
  {
    question: "How is Avocado Oil made?",
    answer: "Avocado Oil is extracted from the soft pulp of ripe avocados using the cold-pressed extraction method to preserve its natural nutrients and beneficial properties.",
  },
  {
    question: "How do you ensure your Avocado Oil is 100% pure?",
    answer: "Every batch undergoes proper in-house lab testing. We also provide COA, MSDS, TDS, and other technical documents to verify the purity and quality of our Avocado Oil.",
  },
  {
    question: "What is the minimum order quantity (MOQ) for bulk Avocado Oil?",
    answer: "Our minimum order quantity for bulk Avocado Oil starts from 25 kg, with secure packaging and worldwide shipping options available.",
  },
];
