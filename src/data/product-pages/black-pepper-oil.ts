 ...
 * Black Pepper Oil
 *
 * Meta title: Black Pepper Oil Manufacturer & Exporter | Bulk Black Pepper Essential Oil Supplier
 * Meta description: Buy bulk Black Pepper Oil and Black Pepper Hydrosol from a leading manufacturer and exporter. 100% pure, steam distilled, with COA, MSDS, and worldwide shipping.
 *
...
export const page: CleanProductPage = {
  ...
  specs: [
    ...
    {
      label: "Other Names",
      value: "Madagascar Pepper Oil, Common Pepper Oil, Pepper Oil",
    },
    {
      label: "Origin",
      value: "India",
    ...
    },
    {
      ...
      value: "Dried Pepper Fruits (Peppercorns)",
    },
    {
      label: "Color",
      value: "Pale Greenish to Light Yellow",
    },
    {
      label: "Aroma",
      value: "Strong, Warm, Musky, and Spicy",
    },
  ],
...
export const faqs: FaqItem[] = [
  {
    question: "Why is Hetaksh Essential Oils is considered a trusted exporter of Black Pepper Essential Oil?",
    answer: "As a leading black pepper oil bulk manufacturer we follow strict quality control, laboratory testing, and provide complete documentation including COA, MSDS, and TDS with every bulk shipment.",
  },
  {
    question: "Do you offer Black Pepper Oil for wholesale and bulk purchase?",
    answer: "Yes. We supply Black Pepper Essential Oil in bulk quantities starting from 25 kg worldwide.",
  },
  {
    question: "Which industries use Black Pepper Hydrosol?",
    answer: "Black Pepper Hydrosol is widely used by skincare, cosmetic, personal care, aromatherapy, wellness, herbal, and pharmaceutical industries for manufacturing facial mists, creams, lotions, shampoos, soaps, and body care products.",
  },
  {
    question: "Is your Black Pepper Hydrosol of good quality?",
    answer: "Yes. Our Black Pepper Hydrosol is manufactured using premium quality black peppercorns through steam distillation and undergoes strict quality testing before dispatch.",
  },
  {
    question: "Do you export Black Pepper Oil worldwide?",
    answer: "Yes. As a trusted bulk exporter, we export Black Pepper Essential Oil and Black Pepper Hydrosol to customers worldwide with secure packaging, complete export documentation, and reliable logistics support.",
  },
];
